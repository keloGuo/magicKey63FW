...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    if(disp_flush_enabled) {
        ...
        LcdPush2(area->x1,area->x2,area->y1,area->y2,(unsigned short *)color_p,(int *)(&disp_drv->draw_buf->flushing));
        //void LcdPush();
        //LcdPush();
    }
...
// {
//     if(disp_drvTemp !=NULL)
//     {
//         lv_disp_flush_ready(disp_drvTemp);
//         disp_drvTemp = NULL;
//     }
//     return 0;
// }
// //这里拿到地址，完成后DMA 自动写0就好
// unsigned int *getlLcdPushOverFlagAddr(void)
// {
//     if(disp_drvTemp !=NULL)
//     {
//         return &disp_drvTemp->draw_buf->flushing;
//     }
//     return NULL;
// }
